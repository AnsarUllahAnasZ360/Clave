...
export function ProjectRow({
	...
	return (
		<div className="border-b border-border/30">
			{/* Project Row */}
			<div
				className="group flex cursor-pointer hover:bg-accent/30 transition-colors"
				onClick={onToggle}
			>
				{/* Project Info */}
				<div className="w-[280px] lg:w-[320px] shrink-0 flex items-center gap-2 px-4 py-3 bg-background sticky left-0 z-10 border-r border-border/40 border-l">
					<button type="button" className="p-0.5 rounded hover:bg-accent">
						{isExpanded ? (
				...
				{/* Project Timeline */}
				<div
					className="relative py-3 pr-4 pt-4 pb-4 shrink-0"
...
function TaskRow({ task, dates, cellWidth }: TaskRowProps) {
	...
	return (
		<div className="group flex hover:bg-accent/20 transition-colors">
			...
			{/* Task Timeline */}
			<div
				className="relative py-2.5 pr-4 shrink-0"
