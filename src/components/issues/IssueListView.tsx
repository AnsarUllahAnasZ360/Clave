...
export function IssueListView({
	...
	const milestoneOptions = useMemo(() => {
		...
		return allMilestones.map((m) => ({ id: m._id as string, name: m.name }));
	}, [allMilestones]);
	...
	const resolveIssueProps = useCallback(
		(issue: IssueListData) => ({
			...
			projectName: issue.projectId
				...
				: undefined,
			milestoneName: issue.milestoneId
				? milestoneMap.get(issue.milestoneId as string)
				: undefined,
		}),
