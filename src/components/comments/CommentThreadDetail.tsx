...
type CommentThreadDetailProps = {
	...
	/** Optional AI context for "Reply with AI" button on comments. */
	aiContext?: {
		workspaceId: string;
		issueId?: string;
		whiteboardId?: string;
...
export function CommentThreadDetail({
	...
	const handleAIReplyGenerated = useCallback((text: string) => {
		...
		<div className="flex flex-1 flex-col min-h-0">
			...
			<div className="flex-1 overflow-y-auto">
				...
				<CommentBubble
					...
					onAIReply={aiContext ? handleAIReplyGenerated : undefined}
					aiContext={aiContext}
				/>
