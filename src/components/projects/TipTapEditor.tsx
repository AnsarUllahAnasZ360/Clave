...
/** Extract plain text from TipTap or BlockNote JSON content, truncated to maxLength */
export function extractTextPreview(
	...
	try {
		...
		// BlockNote JSON: array of blocks with content[].text
		if (Array.isArray(parsed)) {
			...
			function walkBlocks(blocks: BNBlock[]) {
