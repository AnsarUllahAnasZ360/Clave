...
export const Message = ({ className, from, ...props }: MessageProps) => (
	<div
		className={cn(
			"group flex w-full max-w-[95%] flex-col gap-2 animate-[fadeSlideUp_0.3s_ease-out_backwards]",
...
// Lightweight plugins loaded immediately
const lightPlugins = { cjk, code } as unknown as PluginConfig;

// Heavy plugins (mermaid, math) loaded lazily to reduce initial bundle size.
// @streamdown/mermaid bundles its own mermaid library — the cast is safe.
