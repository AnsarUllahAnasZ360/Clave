...
const suggestionVariants = cva(
	cn(
		"bg-emerald-100 text-emerald-700 no-underline transition-colors duration-200 dark:bg-emerald-900/30 dark:text-emerald-300",
	),
	{
		defaultVariants: {
			insertActive: false,
		...
		variants: {
			insertActive: {
				false: "",
				true: "bg-emerald-200/80 dark:bg-emerald-800/40",
			},
			remove: {
				false: "",
				true: "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300",
			},
			removeActive: {
				false: "",
				true: "bg-red-200/80 no-underline dark:bg-red-800/40",
			},
		},
	},
);
