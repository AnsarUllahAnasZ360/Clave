...
/** Filter insert menu groups to only show items whose required plugins are registered. */
...
export function InsertToolbarButton(props: DropdownMenuProps) {
	...
	const filteredGroups = useMemo(() => getFilteredGroups(editor), [editor]);
